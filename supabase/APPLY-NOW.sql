-- ══════════════════════════════════════════════════════════════════
-- LE COMMERCE AGENTIQUE — Setup news_ticker (2 étapes en 1)
--
-- INSTRUCTIONS :
--   1. Ouvre https://supabase.com/dashboard
--   2. Sélectionne ton projet lecommerceagentique
--   3. Menu de gauche → SQL Editor → + New query
--   4. Colle TOUT ce fichier
--   5. Clique "Run" en bas à droite (ou Ctrl+Enter)
--   6. Attendu : "Success. No rows returned." puis "INSERT 0 30"
--
--   Vérifie ensuite sur https://lecommerceagentique.fr — tu verras
--   la section NEWS rouge sous la citation Wikipedia.
-- ══════════════════════════════════════════════════════════════════

-- ──────────────────────────────────────────────────────────────────
-- STEP 1 — Crée la table news_ticker (migration 0002)
-- ──────────────────────────────────────────────────────────────────
...
-- ═══ 25 entrées futures, 1 par jour à 8h du matin ═══
...
-- ══════════════════════════════════════════════════════════════════
-- DONE. Vérifie sur :
--   • https://lecommerceagentique.fr (5 news visibles sous le hero)
--   • https://lecommerceagentique.fr/veille (feed complet daté)
-- ══════════════════════════════════════════════════════════════════
